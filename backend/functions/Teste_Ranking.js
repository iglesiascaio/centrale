...
result = {}
result['Items'] = [{"rating":{"tt3107288":5,"tt0114709":5},"uuid":"caio","type":"user"},{"rating":{"tt2193021":3,"tt3107288":5},"uuid":"matheus","type":"user"},{"rating":{"tt2193021":3,"tt0042286":4},"uuid":"otario","type":"user"}]
...
i_user = user_mapping['matheus']
console.log(i_user)
mean_user = mean(matrix[i_user])
console.log(matrix)
matrix_mean = subtract_mean(matrix)
console.log(matrix)
console.log(matrix_mean)
console.log(intern_product(matrix_mean[0],matrix_mean[1],matrix[0],matrix[1]))
list_similarity = similarity(matrix_mean,'matheus', user_mapping,matrix)

list_rating = rating_films(list_simlarity,'matheus',mean_user,user_mapping,matrix_mean)
...
console.log(list_recommended)
console.log(movie_mapping[list_recommended[0]])